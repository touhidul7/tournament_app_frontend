    ...
    return (
        <div>
            ...
            <div className='py-2 flex items-center justify-between border-b border-cardbg bg-cardbg'>
                ...
                <NavLink to='/notfications' className='flex items-center gap-2 text-white bg-cardbg px-4 py-2 rounded-full ml-7'>
                    <p><Bell className="w-6 h-6 text-blue-500" /></p>
                </NavLink>

                <NavLink to='/notfications' className='flex items-center gap-2 text-white bg-cardbg px-4 py-2 rounded-full mr-2'> <FontAwesomeIcon className='text-2xl' icon={faWallet} /> <p>
