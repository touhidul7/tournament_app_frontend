    ...
    return (
        <div className='max-w-md mx-auto bg-mainbg  font-Jakarta pb-20'>
            ...
            <div className='py-2 flex items-center justify-between border-b border-cardbg'>
                ...
                <div className='flex items-center gap-2 text-white bg-cardbg px-4 py-2 rounded-full mr-2'> <FontAwesomeIcon className='text-2xl' icon={faWallet} /> <p><FontAwesomeIcon icon={faBangladeshiTakaSign} /> <span className='text-green-500'>{deposite}</span> TK</p></div>
            </div>
            {/* profile picure */}
