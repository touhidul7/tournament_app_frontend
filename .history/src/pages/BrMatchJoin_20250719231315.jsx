...
const BrMatchJoin = () => {
    const [joinType, setJoinType] = useState(null); // Default: no input fields
    return (
            ...
            <div className="w-full mt-24 justify-items-center font-Jakarta">
                <div className="w-[95%] bg-cardbg rounded-md text-white py-2">
                    ...
                    <div className="flex items-center justify-center gap-5 mt-4">
                        <button
                            className={`text-lg font-medium w-32 py-2 rounded-md inset-shadow-sm transition-all duration-300 ${joinType === 'solo' ? 'bg-green-600' : 'bg-mainbg'
                                } hover:bg-cardbg`}
                        ...
                        <button
                            className={`text-lg font-medium w-32 py-2 rounded-md inset-shadow-sm transition-all duration-300 ${joinType === 'duo' ? 'bg-green-600' : 'bg-mainbg'
                                } hover:bg-cardbg`}
                    ...
                    {joinType && (
                        <div className="flex flex-col mx-2 mt-6 gap-4">
                            <input
                                className="w-full bg-cardbg inset-shadow-sm px-3 py-3 text-lg font-medium rounded-md focus:outline-none hover:inset-shadow-green-500/60 transition-all duration-300"
                                type="text"
                    ...
                    {joinType && (
                        <div className="flex items-center justify-center gap-5 mt-4 px-2">
                            <button className="text-lg font-medium bg-mainbg w-1/2 py-2 rounded-md inset-shadow-sm hover:bg-cardbg transition-all duration-300">
                                Edit Players
                            </button>
                            <NavLink
                                to="/thankyou"
                                className="text-center text-lg font-medium bg-mainbg w-1/2 py-2 rounded-md inset-shadow-sm hover:bg-cardbg transition-all duration-300"
                            >
                                Confirm and Pay
                            </NavLink>
                        </div>
