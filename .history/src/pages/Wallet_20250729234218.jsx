...
const Wallet = () => {
  const { totalPay, deposite, updateData, withdrawRequest, totalIncome, CheckUser } = useOutletContext();
    ...
    request
      .then((response) => {
        ...
        if (response.status === 201) {
          ...
          reset();
          setShowModal(false);
          sendNotification(user.user.uid, `You have successfully deposited ${data?.amount} BDT from your income.`);
