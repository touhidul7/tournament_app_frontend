...
const BrMatchJoin = () => {
  ...
  <button
    className={`text-lg font-medium w-32 py-2 rounded-md inset-shadow-sm transition-all duration-300 ${
      joinType === "solo" ? "bg-green-600" : "bg-black"
    } hover:bg-green-600`}
  ...
  {/* Duo available only if match type is Duo */}
  {matchDetails.game_type === "Duo" && (
    <button
      className={`text-lg font-medium w-32 py-2 rounded-md inset-shadow-sm transition-all duration-300 ${
        joinType === "duo" ? "bg-green-600" : "bg-black"
      } hover:bg-green-600`}
  ...
  {/* Squad available only if match type is Squad */}
  {matchDetails.game_type === "Squad" && (
    <button
      className={`text-lg font-medium w-32 py-2 rounded-md inset-shadow-sm transition-all duration-300 ${
        joinType === "squad" ? "bg-green-600" : "bg-black"
      } hover:bg-green-600`}
