    ...
    return (
        <div className='max-w-md mx-auto h-screen font-Jakarta bg-mainbg'>
            ...
            <div className="w-full mt-24 justify-items-center font-Jakarta pt-5">
                <div className="w-[95%] bg-cardbg rounded-md text-white p-5">
                    <h1 className="text-md font-semibold ml-2">Solo Time | Mobile | Regular</h1>
                    <p className="text-md text-hoverbg ml-2 mt-3">19/07/2025, 02:00 PM</p>
                    ...
                    {/* === Join type buttons === */}
                    <div className="flex items-center justify-center gap-5 mt-4 p-5">
                        <button
