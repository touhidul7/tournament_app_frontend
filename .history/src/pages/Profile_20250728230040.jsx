            ...
            <div className='bg-slate-100 rounded-lg w-[95%] mx-auto mt-4 mb-5'>
                <div className='grid grid-cols-3 text-cardbg font-semibold px-2 py-1'>
                    <div className='flex flex-col items-center'>
                        <h2>{result.message != "No player results found for this user" ? result.total_games : 0}</h2>
                        <h2>Played</h2>
                    </div>
                    <div className='flex flex-col items-center'>
                        <h2 className=''>{result.message != "No player results found for this user" ? result.total_kill: 0}</h2>
