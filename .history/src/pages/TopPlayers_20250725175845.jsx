...
const TopPlayers = () => {
    ...
    return (
        <div className="max-w-md mx-auto h-screen font-Jakarta bg-mainbg pb-24">
            ...
            {
                topPlayer && topPlayer.length > 0 ? <div className="w-full justify-items-center mt-24">
                    ...
                    <div className="w-full justify-items-center mt-24">
                        <div className="w-[95%] bg-cardbg text-white text-center py-4 rounded-lg">
                            <h2 className="text-lg font-semibold">No Top Players Found</h2>
                        </div>
                    </div>
            }
