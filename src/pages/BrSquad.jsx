            ...
            <section className="w-full mt-24 justify-items-center">
                ...
                <div className="w-[95%]">
                    <div className="relative bg-cardbg rounded-lg p-2">
                        ...
                        <NavLink to='/br-squad-details' className="match-box flex items-center gap-2">
                            <img className="w-16 h-16 rounded-full" src="./image/br-profile.jpg" alt="" />
                            <div className="match-details flex flex-col gap-1.5">
                                <h1 className="text-white font-semibold">BR Squad Match</h1>
                        ...
                        <div className="flex items-center justify-between gap-4 mt-2">
                            ...
                            <div className="mt-5 w-3/4">
                                <div className="w-full h-5 rounded-full bg-hoverbg">
                                    <div className="bg-green-500 h-5 w-64 rounded-full"></div>
                                </div>
                            ...
                            {/* === Joining === */}
                            <div className="w-1/4">
                                <h2 className="bg-green-500 font-semibold text-white text-center p-2 rounded-md">Full</h2>
                            </div>
                        </div>
